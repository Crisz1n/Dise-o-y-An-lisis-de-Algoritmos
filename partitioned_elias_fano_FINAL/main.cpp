 ...
 */
string ejecutar_experimento(const vector<uint64_t>& A,size_t n,const string& dist_nombre, double sigma, int repeticiones_busqueda = 1000)
{
...
void modo_archivo(const string& ruta) {
    ...
    while (true) {
        ...
        //Tomamos el tiempo de la busqueda
        auto t0 = chrono::high_resolution_clock::now();
        int64_t resultado = -1;
